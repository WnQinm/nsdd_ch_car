...
void Read_ADC()
{
    ...
    adc_RR=kalman_filter(&kfp1, adc_mean_filter_convert(ADC1_IN13_C3, 10));//右竖
    adc_L=kalman_filter(&kfp2, adc_mean_filter_convert(ADC1_IN14_C4, 10));//左横
    adc_R=kalman_filter(&kfp3, adc_mean_filter_convert(ADC1_IN15_C5, 10));//右横
#endif
