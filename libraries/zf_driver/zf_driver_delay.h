...
// 备注信息
//-------------------------------------------------------------------------------------------------------------------
#define     system_delay_ms(time)   system_delay((system_clock/8000), (time))             // 设置延时时间 单位 ms
...
//-------------------------------------------------------------------------------------------------------------------
#define     system_delay_us(time)   system_delay((system_clock/8000000), time)            // 设置延时时间 单位 us 范围0 - 16777215(0xffffff)/(DELAY_CLK*1000)ms  主频 120M systick 最大延时时间大约为 139ms
